...
program
  .name('findata')
  .description('Financial data toolkit — parse bank statement PDFs, sync via Plaid, persist to Supabase')
  .version(PARSER_VERSION)
  .argument('[pdf-file]', 'Path to a bank statement PDF (Bank of America supported)')
