...
import type { RawTransaction, AccountInfo, BalanceInfo } from '@findata/boa-parser';
...
import { categorizeTransactionLegacy as categorizeTransaction } from '@findata/categorizer';
