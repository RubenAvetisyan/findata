...
import type { ChannelType } from '@findata/types';
import { categorizeTransaction as categorizeRuleBased, type CategorizationResultV2 as CategorizationResult } from '@findata/categorizer';
